...
const CourseIndexBar: React.FunctionComponent<{course: ICourseState}> = ({course}): ReactElement => {
  ...
  const isCourseIndexOpen = useStoreState(state => state.components.blockPage.isCourseIndexOpen);

  function IndexToggleButton() {
    return (
      <div className={isCourseIndexOpen ? styles.barOpen : styles.bar}
        onClick={() => {
